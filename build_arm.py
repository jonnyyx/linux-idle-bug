...
compiler_arm = "source /opt/sdhr/1.6.0/environment-setup-aarch64-poky-linux; aarch64-poky-linux-gcc -fsanitize=address -lm -Wall -lpthread -O3 -Xlinker -Map=output.map  --sysroot=/opt/sdhr/1.6.0/sysroots/aarch64-poky-linux  "
